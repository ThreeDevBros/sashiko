          ...
          <div className="mt-1 flex items-end justify-between gap-2">
            ...
            {onQuickAdd && (
              ...
              >
                {onQuickRemove && (
                  <div
                    className={`absolute right-0 top-0 h-9 flex items-center rounded-full ring-1 ring-inset ring-primary bg-primary/10 p-0 origin-right transition-all duration-200 ease-out ${
