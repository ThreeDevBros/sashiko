...
function Calendar({ className, classNames, showOutsideDays = true, onClear, showClearButton = true, ...props }: CalendarProps) {
  return (
    <div className="relative">
      <DayPicker
        ...
        classNames={{
          ...
          day_today: "bg-muted text-muted-foreground border border-border",
          day_outside:
